...
namespace DXP.SmartConnectPickup.API.Controllers
{
    ...
    public class BaseApiController : ControllerBase
    {
        ...
        protected readonly ITransactionLogService _transactionLogService;
        ...
        private TResponse ProcessRequest<TRequest, TResponse>(TRequest request, Func<TRequest, ActionResponse<TResponse>> executeRequest)
        {
            ...
            catch (Exception ex)
            {
                ...
                _transactionLogService.AddTransactionLogAsync(TransactionLogStep.BaseApiControllerExceptionHandling,
        ...
        private async Task<TResponse> ProcessRequestAsync<TRequest, TResponse>(TRequest request, Func<TRequest, Task<ActionResponse<TResponse>>> executeRequest)
        {
            ...
            catch (Exception ex)
            {
                ...
                await _transactionLogService.AddTransactionLogAsync(TransactionLogStep.BaseApiControllerExceptionHandling,
                    TransactionLogStatus.Completed,
                    JsonConvert.SerializeObject(request),
                    null,
                    ex.Message,
