        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            catch (Exception ex)
            {
                ...
                using (var scope = _serviceScopeFactory.CreateScope())
                {
                    ...
                    {
                        await transactionLogService.AddTransactionLogAsync(TransactionLogStep.CustomExceptionHandlerMiddleware, TransactionLogStatus.Error, requestData, null, ex.Message, JsonConvert.SerializeObject(ex), Guid.Empty);
                    }
                }
